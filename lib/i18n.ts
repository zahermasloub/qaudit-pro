const I18N = {
  ar: {
    ...
    actions: {
      ...
      uploadEv: "رفع أدلة", runTest: "تنفيذ اختبار", scanAV: "فحص فيروسات", linkTo: "ربط بعينة/اختبار",
  ...
  en: {
    ...
    actions: {
      ...
      uploadEv: "Upload Evidence", runTest: "Run Test", scanAV: "Scan AV", linkTo: "Link to Sample/Test",
