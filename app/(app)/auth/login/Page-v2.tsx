    ...
    try {
      ...
      if (res?.ok) {
        ...
        if (res?.error === 'CredentialsSignin') {
          setErrors({
            password: 'بيانات تسجيل الدخول غير صحيحة - تحقق من البريد الإلكتروني وكلمة المرور',
          });
        } else {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">{t.auth.signin}</h2>
        </div>
