...
<div className="flex gap-6">
  ...
  <div className="flex-1 min-w-0">{/* المحتوى... */}</div>
...
```tsx
<div className="hidden lg:block w-[300px]">{/* Sidebar ثابت 300px */}</div>
```
...
<div className="lg:hidden mb-6">
  <button onClick={() => setIsMobileExpanded(!isMobileExpanded)}>{/* Accordion header */}</button>
  {isMobileExpanded && (
    <div className="space-y-2 max-h-[400px] overflow-y-auto">{/* Steps list */}</div>
  )}
</div>
```
...
<div className="max-w-7xl mx-auto p-6">
  ...
  <div className="flex gap-6">
    <div className="flex-1">{/* المحتوى */}</div>
  </div>
</div>
```
